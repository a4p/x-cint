...
var m = Math,
    ...
    hasTouch = 'ontouchstart' in window && (isAndroid || isIDevice),
	...
	// Helpers
	//MLE patch : force no 3d // translateZ = has3d ? ' translateZ(0)' : '',
	translateZ = '',
...
iScroll.prototype = {
	...
	_start: function (e) {
		var that = this,
			...
			matrix, x, y,
			c1, c2;
		//MLE added - begin (https://code.google.com/p/iscroll-js/issues/detail?id=17)
			/*
