...
function angularInit(element, bootstrap) {
  ...
  //a4p.InternalLog.log('angularInit','Begin');
  ...
  //a4p.InternalLog.log('angularInit','End');
}
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    function Scope() {
      ...
      //a4p.InternalLog.log('Angular - Scope','Begin');
    ...
    Scope.prototype = {
      ...
      $new: function(isolate) {
        ...
        //a4p.InternalLog.log('angular - Scope','New Begin '+isolate);
        ...
        //a4p.InternalLog.log('angular - Scope','New End '+child.$id);
        return child;
      },
      ...
      $watch: function(watchExp, listener, objectEquality) {
        ...
        //a4p.InternalLog.log('angular - Scope','Watch '+' - '+' - '+objectEquality );
      ...
      $apply: function(expr) {
        ...
        //a4p.InternalLog.log('angular - Scope','Apply');
          ...
          if (src) {
            $http.get(src, {cache: $templateCache}).success(function(response) {
              ...
              scope.$eval(onloadExp);
            	...
            	/*
            	//MLE Patch
                //!!!!!!  We are getting an error on some mobile devices even though the HTML is in the response object !!!!!!!
                // ignoring the default angular error handler
                if (thisChangeId !== changeCounter) return;
