...
function angularInit(element, bootstrap) {
  ...
  // CCN
  console.log(new Date().getTime() + ' : angularInit - Begin');
  ...
  // CCN
  console.log(new Date().getTime() + ' : angularInit - End');
}
...
forEach({
  ...
  // CCN
  console.log(new Date().getTime() + ' : JQLite.triggerHandler - Begin - ' + eventName);
  ...
  // CCN
  console.log(new Date().getTime() + ' : JQLite.triggerHandler - End');
  }
}, function(fn, name){
  /**
   * chaining functions
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    function Scope() {
      // CCN
      console.log(new Date().getTime() + ' : angularScope - Constructor');
      this.$id = nextUid();
    ...
    Scope.prototype = {
      ...
      $new: function(isolate) {
        ...
        // CCN
        console.log(new Date().getTime() + ' : angularScope - $new Begin');
        ...
        // CCN
        console.log(new Date().getTime() + ' : angularScope - $new End');
        return child;
      },
      ...
      $watch: function(watchExp, listener, objectEquality) {
        // CCN
        console.log(new Date().getTime() + ' : angularScope - $watch Begin ' + objectEquality);
        var scope = this,
        ...
        // CCN
        console.log(new Date().getTime() + ' : angularScope - $watch End');
        return function() {
          arrayRemove(array, watcher);
        };
      },
      ...
      $digest: function() {
        // CCN
        console.log(new Date().getTime() + ' : angularScope - $digest Begin');
        ...
        clearPhase();
        // CCN
        console.log(new Date().getTime() + ' : angularScope - $digest End');
      },
      ...
      $apply: function(expr) {
        // CCN
        console.log(new Date().getTime() + ' : angularScope - $apply Begin');
        try {
          beginPhase('$apply');
            var r = this.$eval(expr);
        // CCN
        console.log(new Date().getTime() + ' : angularScope - $apply End');
          return r;
        } catch (e) {
          $exceptionHandler(e);
        } finally {
...
function textInputType(scope, element, attr, ctrl, $sniffer, $browser) {
  ...
  // CCN
  console.log(new Date().getTime() + ' : textInputType - Begin');
  ...
  // CCN
  console.log(new Date().getTime() + ' : textInputType - End');
  };
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse',
  ...
  // CCN
  console.log(new Date().getTime() + ' : NgModelController.$setViewValue - Begin');
  ...
  // CCN
  console.log(new Date().getTime() + ' : NgModelController.$setViewValue - End');
  };
