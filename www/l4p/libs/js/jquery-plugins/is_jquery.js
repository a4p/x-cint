(function() {
  ...
  iOSCheckbox = (function() {
    ...
    iOSCheckbox.prototype.onMouseDown = function(event) {
      ...
      //LC: Add an Area for the checkBox in the use of the iPad to click easily
      //var deviceAdapter = a4pDeviceAdapter.GetInstance();
  	  //deviceAdapter.bind_checkbox2area();
    ...
    iOSCheckbox.prototype.onDragMove = function(event, x) {
      ...
      //LC: Change the CSS of text
      if( p >= 0.5){
    	  $('#lbl_on_off').css('color','#CCC');
    	  $('#lbl_on_off_right').css('color','#666');
      }
      else{
    	  $('#lbl_on_off').css('color','#666');
    	  $('#lbl_on_off_right').css('color','#CCC');
      }
    ...
    iOSCheckbox.prototype.onDragEnd = function(event, x) {
      ...
      //console.log(this);
  	   ...
  	   */
  	  //deviceAdapter.bind_fillBtnEvent();
  	  /*
  	   * LC: Refresh the btn CRM in the page of config to solve the problem btn 
  	   * display incorrect
  	   */
  	  //deviceAdapter.bind_checkbox2area();
  	  //deviceAdapter.refresh_config_btnCRM(this);
