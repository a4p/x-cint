...
ChildBrowser.prototype._onEvent = function(data) {
	...
	//alert('_onEvent '+data.type+' loc: '+data.location+' type :'+typeof window.plugins.childBrowser.onLocationChange+' f:'+window.plugins.childBrowser.onLocationChange);
...
ChildBrowser.prototype.showWebPage = function(loc, extension)
{
	if (device.platform === "Android") {
		cordova.exec(this._onEvent, this._onError, "ChildBrowser", "showWebPage", [loc, extension]);
	}
	else {
...
{
	//alert('ChildBrowser.prototype.close '+device.platform);
	if (device.platform === "Android") {
