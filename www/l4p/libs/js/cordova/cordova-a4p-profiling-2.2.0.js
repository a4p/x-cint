...
document.addEventListener('DOMContentLoaded', function() {
        // CCN
        console.log(new Date().getTime() + ' : cordova - DOMContentLoaded');
    channel.onDOMContentLoaded.fire();
}, false);
if (document.readyState == 'complete' || document.readyState == 'interactive') {
        // CCN
        console.log(new Date().getTime() + ' : cordova - complete||interactive');
    channel.onDOMContentLoaded.fire();
}
...
var cordova = {
    ...
    fireDocumentEvent: function(type, data, bNoDetach) {
        // CCN
        console.log(new Date().getTime() + ' : cordova - fireDocumentEvent - Begin ' + type);
        ...
        // CCN
        console.log(new Date().getTime() + ' : cordova - fireDocumentEvent - End ' + type);
    },
    fireWindowEvent: function(type, data) {
        // CCN
        console.log(new Date().getTime() + ' : cordova - fireWindowEvent - Begin ' + type);
        var evt = createEvent(type,data);
        ...
        // CCN
        console.log(new Date().getTime() + ' : cordova - fireWindowEvent - End ' + type);
    },
    ...
    callbackSuccess: function(callbackId, args) {
        try {
        // CCN
        console.log(new Date().getTime() + ' : cordova - callbackSuccess - Begin');
            cordova.callbackFromNative(callbackId, true, args.status, args.message, args.keepCallback);
        // CCN
        console.log(new Date().getTime() + ' : cordova - callbackSuccess - End');
        } catch (e) {
    ...
    callbackError: function(callbackId, args) {
        // CCN
        console.log(new Date().getTime() + ' : cordova - callbackError - Begin');
        ...
        // CCN
        console.log(new Date().getTime() + ' : cordova - callbackError - End');
    },
    ...
    callbackFromNative: function(callbackId, success, status, message, keepCallback) {
        // CCN
        console.log(new Date().getTime() + ' : cordova - callbackFromNative - Begin');
        ...
        // CCN
        console.log(new Date().getTime() + ' : cordova - callbackFromNative - End');
    },
    addConstructor: function(func) {
        channel.onCordovaReady.subscribe(function() {
        // CCN
        console.log(new Date().getTime() + ' : cordova - run constructor - Begin');
            try {
                func();
            } catch(e) {
        ...
        // CCN
        console.log(new Date().getTime() + ' : cordova - run constructor - End');
        });
    }
};
...
function androidExec(success, fail, service, action, args) {
        // CCN
        console.log(new Date().getTime() + ' : cordova - androidExec Begin');
    ...
    if (cordova.callbacks[callbackId]) {
        ...
        // CCN
        console.log(new Date().getTime() + ' : cordova - androidExec End');
    return returnValue;
}

function pollOnce() {
        // CCN
        console.log(new Date().getTime() + ' : cordova - pollOnce Begin');
    var msg = nativeApiProvider.get().retrieveJsMessages();
    androidExec.processMessages(msg);
        // CCN
        console.log(new Date().getTime() + ' : cordova - pollOnce End');
}
...
androidExec.setNativeToJsBridgeMode = function(mode) {
        // CCN
        console.log(new Date().getTime() + ' : cordova - setNativeToJsBridgeMode ' + mode);
...
androidExec.processMessages = function(messages) {
    if (messages) {
        // CCN
        console.log(new Date().getTime() + ' : cordova - androidExec.processMessages Begin');
        ...
        // CCN
        console.log(new Date().getTime() + ' : cordova - androidExec.processMessages End');
    }
};
...
module.exports = {
  ...
  loadUrl:function(url, props) {
        // CCN
        console.log(new Date().getTime() + ' : cordova - loadUrl Begin');
    exec(null, null, "App", "loadUrl", [url, props]);
        // CCN
        console.log(new Date().getTime() + ' : cordova - loadUrl End');
  },
  ...
  cancelLoadUrl:function() {
        // CCN
        console.log(new Date().getTime() + ' : cordova - cancelLoadUrl Begin');
    exec(null, null, "App", "cancelLoadUrl", []);
        // CCN
        console.log(new Date().getTime() + ' : cordova - cancelLoadUrl End');
  },
